...
La probabilité qu’une $χ^2$ à `r ct$parameter` degrés de liberté soit aussi extrême que celle observée est la suivante. Notons qu’on n’utilise pas la p-value fournie par R, car celle-ci utilise un nombre de degrés de liberté non corrigés par nos estimations.
